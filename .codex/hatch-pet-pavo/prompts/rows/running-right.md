Create one horizontal animation strip for Codex pet `pavo`, state `running-right`.
...
Identity: same pet in every frame: Compact peacock mascot with a rounded fan-tail, jewel-toned plumage, and a poised helper vibe inspired by item photography and review work; plush or sticker-friendly, readable at sprite size.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
