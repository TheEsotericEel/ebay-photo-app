...
The current implementation is split into a mobile capture screen that opens the camera on demand and a desktop management shell with fixed Capture, Queue, and Tools panels.
